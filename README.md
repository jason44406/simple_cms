...
- 2018/04/10 - Added an audit log to record actions on objects.  Also updated the seeds file.  Still working on the section delete -- there's some kind of hiccup with the redirect after the destroy because it can't seem to look up the page.  Not sure why because the same methods in the pages controller seem to work fine.  
